...
public class FormSuratJalan extends AbstractAuditingEntity<String> implements Serializable, Persistable<String> {
    ...
    public FormSuratJalan createdDate(Instant createdDate) {
    ...
    public FormSuratJalan createdBy(String createdBy) {
    ...
    public FormSuratJalan lastModifiedDate(Instant lastModifiedDate) {
    ...
    public FormSuratJalan lastModifiedBy(String lastModifiedBy) {
