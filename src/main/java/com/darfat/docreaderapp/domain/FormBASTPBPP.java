...
public class FormBASTPBPP implements Serializable, Persistable<String> {
    ...
    public FormBASTPBPP createdDate(Instant createdDate) {
    ...
    public FormBASTPBPP createdBy(String createdBy) {
    ...
    public FormBASTPBPP lastModifiedDate(Instant lastModifiedDate) {
    ...
    public FormBASTPBPP lastModifiedBy(String lastModifiedBy) {
