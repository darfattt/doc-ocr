...
/**
 * Criteria class for the {@link com.darfat.docreaderapp.domain.Documents} entity. This class is used
 * in {@link com.darfat.docreaderapp.web.rest.DocumentsResource} to receive all the possible filtering options from
...
public class DocumentsCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, type, name, status, createdDate, createdBy, lastModifiedDate, lastModifiedBy, distinct);
    }
